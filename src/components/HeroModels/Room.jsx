...
*/
import { useGLTF, useTexture } from '@react-three/drei' //GTLT
import * as THREE from 'three' //to be able to use the materials
export function Room(props) {
  const { nodes, materials } = useGLTF('/models/optimized-room.glb'); //AUto gltfjs
  const matcapTexture = useTexture('/images/textures/mat1.png'); //texture image
  const curtainMaterial = new THREE.MeshPhongMaterial({color:'#d90429'});
  const ol = new THREE.MeshPhongMaterial({color:'white'});
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.body1_blinn1_0.geometry} material={ol} />
